...
def getLink(soup):
    ...
    #need to leverage soup and then bring it into the table tag with the admissions...? but...
    #stuck...come back...
...
def getAdmissionsInfo2019(soup):
    ...
    for tr_tag in tr_list[1:]:
        ...
        name_school = td_list[0].text.strip()
        year_founded = td_list[1].text.strip()
        d[name_school] = year_founded
